...
CS101_InterrogationHandler interrogationHandler_create()
{
    return (CS101_InterrogationHandler) interrogationHandler;
}

CS101_ASDUHandler asduHandler_create()
{
    return (CS101_ASDUHandler) asduHandler;
}

CS104_ConnectionRequestHandler connectionRequestHandler_create()
{
    return (CS104_ConnectionRequestHandler) connectionRequestHandler;
}
